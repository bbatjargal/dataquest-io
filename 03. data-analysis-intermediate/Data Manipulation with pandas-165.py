...
protein_g = food_info["Protein_(g)"]
lipid_tot_g = food_info["Lipid_Tot_(g)"]

normalized_protein = (protein_g - protein_g.min()) / (protein_g.max() - protein_g.min())
normalized_fat = (lipid_tot_g - lipid_tot_g.min())/(lipid_tot_g.max()-lipid_tot_g.min())
